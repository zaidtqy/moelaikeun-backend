    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="">
                    <a href="{{ route('products.index') }}"> <i class="menu-icon fa fa-archive"></i>Lihat Produk</a>
                </li>
                <li class="">
                ...
                <li class="">
                    <a href="{{ route('product-galleries.index') }}"> <i class="menu-icon fa fa-camera"></i>Lihat Foto Produk</a>
                </li>
                <li class="">
                ...
                <li class="">
                    <a href="{{ route('transactions.index') }}"> <i class="menu-icon fa fa-exchange"></i>Lihat Transaksi</a>
                </li>
            </ul>
        </div><!-- /.navbar-collapse -->
    </nav>
