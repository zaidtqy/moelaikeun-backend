    ...
    <div class="card-body card-block">
        <form action="{{ route('product-galleries.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <br>
                <label>
                    <input type="radio" name="is_default" value="1" class="form-check @error('is_default') is-invalid @enderror" /> Ya
                </label>
                &nbsp;
                <label>
                    <input type="radio" name="is_default" value="0" class="form-check @error('is_default') is-invalid @enderror" /> Tidak
                </label>
